...
public class NivoBarTicketsDAOByMonth extends TicketMainDAO {
	...
	public NivoBarTicketsDAOByMonth(String month, Long fifteenMinutes, Long oneDay, Long oneDayAll, Long twoZones, Long threeZones, Long fourZones, Long fiveZones, Long sixZones, Long sevenZones, Long eightZones, Long nineZones, Long tenZones, Long elevenZones) {
